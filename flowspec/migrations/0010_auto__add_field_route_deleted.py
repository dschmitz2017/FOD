...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.deleted'
        db.add_column(u'route', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Route.deleted'
        db.delete_column(u'route', 'deleted')
    ...
    models = {
        ...
        'flowspec.rule': {
            ...
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 10, 18, 0, 0)'}),
