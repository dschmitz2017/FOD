...
urlpatterns = patterns(
    ...
    url(r'^edit/(?P<rule_slug>[\w\-]+)/$', 'flowspec.views.edit_route', name="edit-route"),
    url(r'^delete/(?P<rule_slug>[\w\-]+)/$', 'flowspec.views.delete_rule', name="delete-route"),
    ...
    url(r'^rulestats/(?P<route_slug>[\w\-]+)/$', 'flowspec.views.rulestats', name="rulestats"),
